        ...
        if (cm.getJobId() % 10 == 2) {
            ...
            if (cm.getJobId() % 1000 == 0) {
                if (cm.getLevel() >= 10){
                        ...
                        possibleJobs.push(1100);
                        possibleJobs.push(1200);
                        possibleJobs.push(1300);
                        possibleJobs.push(1400);
                        possibleJobs.push(1500);
