    ...
    if (status == 1) {
        ...
        if (cm.getMeso() > price) {
            if (selection == 0) {
                ...
                for each(var i in selection == 1 ? hair : hair) {
